...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case BookSessionPage.RouteName:
      ...
      return MaterialPageRoute(builder: (context) => BookSessionPage(id: args.therapistId, sessionId: args.id,));
   case SessionPage.RouteName:
    ...
    case ReviewPage.RouteName:
      final ReviewPageArgument result = settings.arguments;
      return MaterialPageRoute(builder: (context) => ReviewPage(id:result.id, programName: result.name,));
    ...
    case ChatPage.RouteName:
      ...
      return MaterialPageRoute(builder: (context) => ChatPage(senderId: args.senderId, receiverImg: args.receiverImg,));
